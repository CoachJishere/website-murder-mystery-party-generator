...
Two fixes flagged as follow-ups in [ADR-0089](docs/adr/0089-child-scenario-id-chaining-and-filter-operator-regression.md), addressed same-day. First confirmed `temp-files/MM Live - Child (Unified)31-CharacterContentLanguageMatch.blueprint.json` (not v30) was the true newest head — Jonathan had added it after v30 for the separate language-match fix — and confirmed it already carried v30's id-chaining pattern before branching off it.
