...
| Child19 (G8 slip, G9 brackets, G2 victim) | 2026-07-25 (`…Child (Unified)19-SlipGuilt-OutputHygiene-VictimQuestions`) | `SLIP-STYLE GUILT` | 2026-07-25 (Jonathan, Make UI) | pending — verify on next-purchase smoke test |
| Parent48 (G7 victim, G8 no-fixed-culprit, G9 output_hygiene) | 2026-07-25 (`…Parent48 (Victim-Consistency + No-Fixed-Culprit + Output-Hygiene)`) | `VICTIM CONSISTENCY` / `output_hygiene` | 2026-07-25 (Jonathan, Make UI) | pending — verify on next-purchase smoke test |
