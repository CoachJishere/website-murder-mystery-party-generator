...
const EN_SLUG = 'ancient-egypt-murder-mystery-party-guide';
const KO_SLUG = 'ancient-egypt-murder-mystery-party-guide-ko';
...
async function main() {
  try {
    ...
    console.log('✅ POST 3 COMPLETE: Ancient Egypt');
  } catch (error) {
