...
console.log(`Found ${batch.length} posts for Danish batch 3:`);
batch.forEach((p, i) => {
  console.log(`${i + 11}. ${p.title}`);
...
writeFileSync('danish-batch3-posts.json', JSON.stringify(batch, null, 2));
console.log('\nSaved to danish-batch3-posts.json');
