...
const EN_SLUG = 'detective-murder-mystery-themes-professional-investigators-sleuth-dynamics';
const KO_SLUG = 'detective-murder-mystery-themes-professional-investigators-sleuth-dynamics-ko';
...
async function main() {
  try {
    ...
    console.log('✅ POST 4 COMPLETE: Detective Themes');
  } catch (error) {
