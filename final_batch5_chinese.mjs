...
// Translation function for standard parts
...
// Insert each translation - WITHOUT keywords or featured fields
for (const translation of translations) {
  ...
  if (error) {
    ...
    console.log(`✅ ${translation.num}/25 - Success: ${translation.slug}`);
  }
