...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; max-width: 600px; margin: 0 auto; padding: 20px; background: #000000;">
  ...
  <div style="background: #111111; padding: 30px; border-radius: 0 0 8px 8px;">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="${guideUrl}" style="display: inline-block; background: #C81400; color: #F5F0E8; padding: 15px 40px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">View Host Guide</a>
    </div>
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; max-width: 600px; margin: 0 auto; padding: 20px; background: #000000;">
  ...
  <div style="background: #111111; padding: 30px; border-radius: 0 0 8px 8px;">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="${detectiveUrl}" style="display: inline-block; background: #C81400; color: #F5F0E8; padding: 15px 40px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">View Detective Kit</a>
    </div>
