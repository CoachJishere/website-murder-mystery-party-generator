...
// ADR-0097 Addendum (2026-09-11, moved to _shared/conversation-excerpt.ts
// 2026-09-12 so regenerate-child-content can reuse the identical logic
// instead of drifting its own copy): see that file's doc comment for why
// this windowing exists and the incident that made it necessary.
